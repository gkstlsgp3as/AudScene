...
if __name__ == "__main__":
    ...
    alpha_type_ = [0.7, 0, 0.3] # If you don't want to use guiding token, set this value to [0, 0, 1]
    save_folder_name_ = args.save_folder_name
    bbox_for_all = [[0, 0, 511, 511]] # [xmin, ymin, xmax, ymax]
    cond_word = " "
    meta_list = [
        dict(
            prompt = "A photo of the {}cattle mooing".format(cond_word),
        ...
        dict(
            prompt = "A photo of the {}cat meowing".format(cond_word),
            alpha_type = alpha_type_, # If you don't want to use guiding token, set this value to [0, 0, 1]
        ...
        dict(
            prompt = "A photo of the {}frog croaking".format(cond_word),
            alpha_type = alpha_type_, # If you don't want to use guiding token, set this value to [0, 0, 1]
        ...
        dict(
            prompt = "A photo of the {}volcano explosion".format(cond_word),
            alpha_type = alpha_type_, # If you don't want to use guiding token, set this value to [0, 0, 1]
        ...
        dict(
            prompt = "A photo of the {}dog barking".format(cond_word),
            alpha_type = alpha_type_, # If you don't want to use guiding token, set this value to [0, 0, 1]
        ...
        dict(
            prompt = "A photo of the {}horse neighing".format(cond_word),
            alpha_type = alpha_type_, # If you don't want to use guiding token, set this value to [0, 0, 1]
        ...
        dict(
            prompt = "A photo of the {}owl hooting".format(cond_word),
            alpha_type = alpha_type_, # If you don't want to use guiding token, set this value to [0, 0, 1]
        ...
        dict(
            prompt = "A photo of the {}duck quacking".format(cond_word),
            alpha_type = alpha_type_, # If you don't want to use guiding token, set this value to [0, 0, 1]
        ...
        dict(
            prompt = "A photo of the {}pig oinking".format(cond_word),
            alpha_type = alpha_type_, # If you don't want to use guiding token, set this value to [0, 0, 1]
        ...
        dict(
            prompt = "A photo of the {}cricket chirping".format(cond_word),
            alpha_type = alpha_type_, # If you don't want to use guiding token, set this value to [0, 0, 1]
        ...
        dict(
            prompt = "A photo of the {}fire crackling".format(cond_word),
            alpha_type = alpha_type_, # If you don't want to use guiding token, set this value to [0, 0, 1]
        ...
        dict(
            prompt = "A photo of the {}lions roaring".format(cond_word),
            alpha_type = alpha_type_, # If you don't want to use guiding token, set this value to [0, 0, 1]
        ...
        dict(
            prompt = "A photo of the {}ocean burbling".format(cond_word),
            alpha_type = alpha_type_, # If you don't want to use guiding token, set this value to [0, 0, 1]
        ...
        dict(
            prompt = "A photo of the {}bird chirping, tweeting".format(cond_word),
            alpha_type = alpha_type_, # If you don't want to use guiding token, set this value to [0, 0, 1]
