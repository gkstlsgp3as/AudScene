...
sys.path.append(home_path + "/GLIGEN")
...
if __name__ == "__main__":
    eval_model(args)
    ## python captioning/llava/eval/model.py --dataset {datasetname}
    ## captions will be saved in './{dataset}/{llm}/{vlm}/step1_result.jsonl'.
    ## reference: https://github.com/sehyunkwon/ICTC/tree/main
