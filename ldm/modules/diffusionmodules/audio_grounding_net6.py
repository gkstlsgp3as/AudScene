...
class PositionNet(nn.Module):
    ...
    def forward(self, audio_embeddings, mask, bbox):
        ...
        objs_4 = self.linears_4(torch.cat([audio_embeddings, xyxy_embedding], dim=-1))
        B, N, C = objs_1.shape
        objs = torch.stack([objs_1, objs_2, objs_3, objs_4], dim=2).view(B, N * 4, C)
